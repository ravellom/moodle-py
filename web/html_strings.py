...
intro = """
        ...
        Esta aplicación analiza los ficheros csv descargados de   \
        Administración de sistema/Reportes activos! 
        Por lo cual es independiente de la versión de moodle y ayuda a los profesores a  \
        realizar análisis gobales y particulares a partir de los datos de sus cursos
